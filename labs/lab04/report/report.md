...
1. Создаю каталог lab04, перехожу в него, создаю пустой файл hello.asm.
...
![Трансляция и запуск программы](image/03.png){ #fig:003 width=70%, height=70% }

Оба исполняемых файла выводят сообщение Hello World, так как они собраны из одного кода.
...
![Трансляция и запуск программы lab4.asm](image/05.png){ #fig:005 width=70%, height=70% }

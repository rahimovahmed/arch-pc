...
![report.md](image/05.png){ #fig:005 width=70%, height=70% }

![report.md](image/06.png){ #fig:006 width=70%, height=70% }
...
9. В качестве самостоятельного задания нужно сделать в md формате отчет для лабораторной 2.

![Заполним шаблон для отчета](image/08.png){ #fig:008 width=70%, height=70% }
